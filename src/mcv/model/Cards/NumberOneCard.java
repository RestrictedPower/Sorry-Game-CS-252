...
/**
 * This class represents the number 1 Card.
 * 
 * @author Kostas Anemozalis (CSD4149)
 */
public class NumberOneCard extends NumberCard{

	public NumberOneCard(String img) {
		super(img, 1);
	}
	
	public void move(Player p) {
		ArrayList<String> options = new ArrayList<String>();
		int pos1 = Util.getForwardPossition(p.getPawn1(), 1, true);
		int pos2 = Util.getForwardPossition(p.getPawn2(), 1, true);
